...
CREATE TABLE IF NOT EXISTS `optica_cul_ampolla`.`client` (
  ...
  INDEX `fk_client_client1_idx` (`client_id_recomendado` ASC),
...
CREATE TABLE IF NOT EXISTS `optica_cul_ampolla`.`adreça` (
  ...
  INDEX `fk_adreça_proveidor1_idx` (`proveidor_id_proveidor` ASC),
  INDEX `fk_adreça_client1_idx` (`client_id_client` ASC),
...
CREATE TABLE IF NOT EXISTS `optica_cul_ampolla`.`gafas` (
  ...
  PRIMARY KEY (`id_gafas`, `proveidor_id_proveidor`),
  INDEX `fk_gafas_proveidor1_idx` (`proveidor_id_proveidor` ASC),
...
CREATE TABLE IF NOT EXISTS `optica_cul_ampolla`.`venta` (
  ...
  PRIMARY KEY (`id_venta`, `empleat_id_empleat`, `client_id_client`, `gafas_id_gafas`),
  INDEX `fk_venta_empleat1_idx` (`empleat_id_empleat` ASC),
  INDEX `fk_venta_client1_idx` (`client_id_client` ASC),
  INDEX `fk_venta_gafas1_idx` (`gafas_id_gafas` ASC),
